          ...
          <div class="col-sm-8 col-lg-4 d-flex justify-content-end gap-5 align-items-center mt-4 mt-sm-0 justify-content-center justify-content-sm-end">
            ...
            <ul class="d-flex justify-content-end list-unstyled m-0">
              <?php if (isset($_SESSION['user_id'])): ?>
                ...
                <li>
                  <a href="logout.php" class="mx-1">تسجيل الخروج</a>
                </li>
                <li>
                  <a href="user_dashboard.php" class="mx-1">لوحة المستخدم</a>
                </li>
              <?php else: ?>
                <li>
                  <a href="login.php" class="mx-1">تسجيل الدخول</a>
                </li>
                <li>
                  <a href="register.php" class="mx-1">إنشاء حساب</a>
                </li>
              <?php endif; ?>
              <li>
                <a href="#" class="mx-1" data-bs-toggle="offcanvas" data-bs-target="#offcanvasCart" aria-controls="offcanvasCart">
                  🛒 سلة (<span class="cart-count"><?php echo isset($_SESSION['cart']) ? count($_SESSION['cart']) : 0; ?></span>)
                </a>
              </li>
            </ul>
          </div>
